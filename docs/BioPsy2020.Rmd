...
- Use `repro::automate()` to setup _all_ components
...
We need scientific software to be maintained

- Make, Docker, git
- but note that repro itself is not needed to reproduce a workflow that was created with repro
