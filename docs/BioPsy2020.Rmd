...
Confidence intervals (95%) of a simple regression coefficient estimate:
...
- use `automate_load_packages()` to load all packages in your script and  `automate_load_scripts()` to attach external scripts
...
- We need to better recognize the efforts of maintaining scientific software (such as repro) and curating digital collections
